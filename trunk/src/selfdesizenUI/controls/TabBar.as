...
*/
package  selfdesizenUI.controls
{
	...
	import selfdesizenUI.controls.tabBarClasses.TabButton;
	import selfdesizenUI.event.TabBarEvent;
	 ...
	 */
	[Event(name="itemRollOut", type="selfdesizenUI.event.TabBarEvent")]
	
	/**
	 * Dispatched when the user rolls the pointer over an tab in the component.
     *
     * @eventType selfdesizenUI.event.TabBarEvent.ITEM_ROLL_OVER
     *
     * @see #event:itemRollOut
	 */
	[Event(name="itemRollOver", type="selfdesizenUI.event.TabBarEvent")]
     ...
     *
     * @eventType selfdesizenUI.event.TabBarEvent.ITEM_CLICK
	 */
	[Event(name="itemClick", type="selfdesizenUI.event.TabBarEvent")]
